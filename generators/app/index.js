...
class TrackMailGenerator extends Generator {
  ...
  prompting() {
    ...
    return this.prompt([
      ...
      },
      {
        ...
        default(answers) {
          return `${answers.course}-mail-${year}-${to.slug(user || path.basename(this.destinationPath()) || '')}`;
        },
      },
      {
  ...
  writing() {
    ...
    this.fs.copy(this.templatePath('docker/frontend/Caddyfile'), this.destinationPath('docker/frontend/Caddyfile'));
    this.fs.copy(
    ...
    this.fs.copy(this.templatePath('docker-compose-prod.yml'), this.destinationPath('docker-compose-prod.yml'));
    ...
    this.fs.copyTpl(this.templatePath('src/components/Header.js'), this.destinationPath('src/components/Header.js'), {
